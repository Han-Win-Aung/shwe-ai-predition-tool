...
def train_model(filename):
    ...
    # 🔮 Predict future values (Feb 8 - Feb 28, 2025)
    # future_dates = pd.date_range("2025-02-08", "2025-02-28")
    ...
    fig2.update_layout(title="Future Predictions (Feb 8 - 28, 2025)", xaxis_title="Date", yaxis_title="Net Interest Gap", xaxis=dict(dtick="10D"))  # Set tick interval to 10 days
